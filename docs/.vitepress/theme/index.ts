...
// MCSM 服务器组件
import ServerStatusCards from './components/MCSM/ServerStatusCards.vue'
import MiniGameInstances from './components/MCSM/MiniGameInstances.vue'
...
export default {
  ...
  async enhanceApp({ app, router }) {
    ...
    // MCSM服务器状态卡片
    app.component('server-status-cards', ServerStatusCards);
    app.component('mini-game-instances', MiniGameInstances);
