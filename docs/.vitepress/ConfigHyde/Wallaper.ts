/*
 * @Date: 2026-03-12 14:25:37
 * @LastEditors: Guailoudou guailoudou@outlook.com
 * @LastEditTime: 2026-03-12 14:37:48
 * @FilePath: \YunMoan-docs\docs\.vitepress\ConfigHyde\Wallaper.ts
 */
// 首页壁纸 - 动态获取本地图片服务器的图片
...
const fallbackImages = [
  "img/yezimoan-bg-1.avif",
  "img/yezimoan-bg-2.avif",
  "img/yezimoan-bg-3.avif",
];
// 动态获取图片列表的函数
