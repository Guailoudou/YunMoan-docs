...
const teekConfig = defineTeekConfig({
  ...
  blogger: {
    // 博主信息，显示在首页侧边栏
    avatar: "/img/YeziMoan-2D.png",  //侧边栏个人头像
    shape: "circle-rotate", // 头像风格：square 为方形头像，circle 为圆形头像，circle-rotate 可支持鼠标悬停旋转
    name: "YeziMoan", // 侧边栏个人昵称
    slogan: "花时间省钱花时间", // 侧边栏个人座右铭
...
// 布蒜子统计分析
  ...
  riskLink: {
    ...
    whitelist: ["https://docs.yw-games.top/","http://game.yezimoan.xyz/"], // 白名单，匹配到的链接不提示风险
...
export default defineConfig({
  ...
  vite: {
    server: {
      ...
      port: 25569, // 指定开发服务器端口
      strictPort: true, // 若端口已被占用则会直接退出
      open: true, // 运行后自动打开网页
	  allowedHosts: ["game.yezimoan.xyz"]
    },
      ...
      AutoFrontmatter({
          ...
          transform: (frontMatter: Record<string, any>, fileInfo: FileInfo) => {
              ...
              const rules: TransformRule[] = [
                  ...
                  { folderName: "00.公益", prefix: "/welfare/$uuid5", removeLevel: 99},
                  { folderName: "01.神人记录", prefix: "/patient/$uuid5", removeLevel: 99},
                  { folderName: "11.我的世界", prefix: "/minecraft/$uuid5", removeLevel: 99},
                  { folderName: "21.Steam", prefix: "/steam/$uuid5", removeLevel: 99},
                  { folderName: "90.关于", prefix: "/about/$uuid5"}, 
                  { folderName: "100.Teek", prefix: "/teek/$uuid5"}, 
              ];
              // 应用规则转换
